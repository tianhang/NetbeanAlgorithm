...
${OBJECTDIR}/HeapSort.o: HeapSort.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HeapSort.o HeapSort.cpp

${OBJECTDIR}/InorderTraversal.o: InorderTraversal.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InorderTraversal.o InorderTraversal.cc

${OBJECTDIR}/QuickSort.o: QuickSort.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QuickSort.o QuickSort.cpp

${OBJECTDIR}/RadixSort.o: RadixSort.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RadixSort.o RadixSort.cpp
...
${OBJECTDIR}/SortList.o: SortList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SortList.o SortList.cpp
...
${OBJECTDIR}/heapsort2.o: heapsort2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/heapsort2.o heapsort2.cpp
...
${OBJECTDIR}/memcpy.o: memcpy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/memcpy.o memcpy.cpp

${OBJECTDIR}/postOrderTraversal.o: postOrderTraversal.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/postOrderTraversal.o postOrderTraversal.cpp
...
${OBJECTDIR}/threads.o: threads.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/threads.o threads.cpp
